...
pppd $QL_DEVNAME 115200 user "$QL_USER" password "$QL_PASSWORD" \
     ...
     noauth debug defaultroute noipdefault novj novjccomp noccp ipcp-accept-local ipcp-accept-remote ipcp-max-configure 30 \
     local lock modem dump nodetach nocrtscts usepeerdns
